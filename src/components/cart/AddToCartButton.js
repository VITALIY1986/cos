        ...
        <div>
            ...
            {"ExternalProduct" === product.__typename ? (
                ...
                <button
                    ...
                    className={cx(
                        'px-8 py-5 rounded-sm  text-sm border-solid border-red-400 border border-current mt-3',
            ...
            {showViewCart ? (
                <Link href="/cart">
                    <button
                        className="px-8 py-5 rounded-sm text-sm border-solid border border-current border-red-400 inline-block hover:bg-red-400 hover:text-white ">Vizualizare coș
